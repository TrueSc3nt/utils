-- Mountain Hub v3.2 - Diagnostic Raw Loader
-- Reports errors with section markers
local success, err = pcall(function()
-- Mountain Hub v3.2 - DIAGNOSTIC BUILD
print("[DIAG] v3.2 diagnostic script starting...")
    ████████╗██╗  ██╗███████╗    ██╗███████╗ ██████╗ ███████╗████████╗
    ╚══██╔══╝██║  ██║██╔════╝    ██║██╔════╝██╔═══██╗██╔════╝╚══██╔══╝
       ██║   ███████║█████╗      ██║███████╗██║   ██║███████╗   ██║   
       ██║   ██╔══██║██╔══╝      ██║╚════██║██║   ██║╚════██║   ██║   
...
-- ══════════════════════════════════════════════════════════════════════════════
-- ══════════════════════════════════════════════════════════════════════════════
print("[DIAG] >>> Section: Mountain Reset Handler")
-- v3.2 ADDITIONS: ALL EXPLOITS + PICKAXE SHOP + MOUNTAIN RESET + DISCORD WEBHOOK
-- ===========================================================================
print("[DIAG] >>> Section: Discord Webhook System")
...
-- ══════════════════════════════════════════════════════════════════════════════
print("[DIAG] >>> Section: GUI Utility")
...
-- ══════════════════════════════════════════════════════════════════════════════
print("[DIAG] >>> Section: GUI Construction")
...
-- ══════════════════════════════════════════════════════════════════════════════
print("[DIAG] >>> Section: Stats Overlay")
...
-- ══════════════════════════════════════════════════════════════════════════════
print("[DIAG] >>> Section: Initialization")
-- INITIALIZATION
-- ══════════════════════════════════════════════════════════════════════════════
LoadConfig()
StartAntiAFK()
...
local _ok, _err = pcall(function() StartWebhookProcessor() end)
if not _ok then warn("[DIAG] StartWebhookProcessor ERROR: " .. tostring(_err)) print("[DIAG] StartWebhookProcessor ERROR: " .. tostring(_err)) end
print("[DIAG] StartWebhookProcessor completed")


-- v3.2 System initialization
local _ok2, _err2 = pcall(function() ScanPickaxes() end)
if not _ok2 then warn("[DIAG] ScanPickaxes ERROR: " .. tostring(_err2)) print("[DIAG] ScanPickaxes ERROR: " .. tostring(_err2)) end
print("[DIAG] ScanPickaxes completed")
local _ok3, _err3 = pcall(function() StartMountainResetHandler() end)
if not _ok3 then warn("[DIAG] StartMountainResetHandler ERROR: " .. tostring(_err3)) print("[DIAG] StartMountainResetHandler ERROR: " .. tostring(_err3)) end
print("[DIAG] StartMountainResetHandler completed")
...
if not success then
    warn("[MtHub v3.2 DIAG] ERROR: " .. tostring(err))
    print("[MtHub v3.2 DIAG] ERROR: " .. tostring(err))
end
