...
if false then local _dmc1cuox=typeof(Instance.new("Part")) end
local _vigmhnzg = {
    _cq0k5ozj = false,
    _ci3ro08l = false,
    _czs09h1q = false,
...
_v1931zu6.Name = _xD("107|184|204|212|217|177|221|204|216|208")
...
_v06v4b97.Name = _xD("79|150|187|176|194|194|145|187|196|193")
...
_vci80ezr.Name = _xD("55|127|156|152|155|156|169")
...
_v0carbvl.Text = _xD("94|320|249|237|126|171|199|204|195|191|126|171|205|211|204|210|191|199|204|126|212|148")
...
_v57v46rq.Text = _xD("91|317|246|234|123|168|196|201|192|188")
...
_v8wj7q5h.Name = _xD("52|136|149|150|118|149|166")
...
local _l8yp6dwt = {_xD("59|129|156|173|168"), _xD("122|205|223|230|230"), _xD("101|170|184|181"), _xD("105|174|225|217|213|216|210|221"), _xD("100|177|205|215|199")}
local _v0b4dvca = {}
local _v9ijv2j3 = {}

for i, tabName in ipairs(_l8yp6dwt) do
    local tabBtn = Instance.new("TextButton")
    tabBtn.Name = tabName .. _xD("73|157|170|171")
    tabBtn.Size = UDim2.new(0.2, 0, 1, 0)
    tabBtn.BackgroundColor3 = (tabName == _xD("108|178|205|222|217")) and Color3.fromRGB(50, 90, 200) or Color3.fromRGB(30, 30, 50)
...
_vq8vv3vr.Name = _xD("65|132|176|175|181|166|175|181|130|179|166|162")
...
for _, tabName in ipairs(_l8yp6dwt) do
    ...
    tabFrame.Name = tabName .. _xD("77|144|188|187|193|178|187|193")
    ...
    tabFrame.Visible = (tabName == _xD("53|123|150|167|162"))
...
local function _fp1qs1bk(parent, name, default, callback)
    ...
    toggleBtn.Text = default and _xD("56|135|134") or _xD("117|196|187|187")
    ...
    toggleBtn.MouseButton1Click:Connect(function()
        ...
        toggleBtn.Text = toggled and _xD("121|200|199") or _xD("106|185|176|176")
        callback(toggled)
    end)
...
local _lrfe53he = _v9ijv2j3[_xD("111|181|208|225|220")]

_fm1kc2sz(_lrfe53he, _xD("118|358|277|265|256|150|201|202|183|202|201"))
_vtzyepru = _vtzyepru + 1
...
_v9u94k29.Name = _xD("110|193|226|207|226|225|194|211|230|226")
_v9u94k29.Size = UDim2.new(1, -12, 1, 0)
_v9u94k29.Position = UDim2.new(0, 6, 0, 0)
_v9u94k29.BackgroundTransparency = 1
_v9u94k29.Text = _xD("56|133|161|166|157|156|114|88|104|88|180|88|139|157|164|164|171|114|88|104|88|180|88|140|153|170|159|157|172|114|88|134|167|166|157")
...
local function _fr7sy4yx()
    _v9u94k29.Text = _xD("41|118|146|151|142|141|99|73") .. _v4a9zyim._s0886rnb .. _xD("109|141|233|141|192|210|217|217|224|167|141") .. _v4a9zyim._sxz16dwg .. _xD("69|101|193|101|137|186|181|170|127|101") .. _v4a9zyim._s181j31y .. _xD("124|156|248|156|208|221|238|227|225|240|182|156") .. (_v4a9zyim._s71sqkis or _xD("124|202|235|234|225"))
end

_fm1kc2sz(_lrfe53he, _xD("63|289|218|206|95|128|148|147|142|95|133|128|145|140"))

_fp1qs1bk(_lrfe53he, _xD("77|142|194|193|188|109|147|174|191|186|109|159|188|176|184|192|124|144|191|198|192|193|174|185|192"), false, function(val)
    _vigmhnzg._cq0k5ozj = val
    if val then _f9r07484() else _fx3861n5() end
end)

_fp1qs1bk(_lrfe53he, _xD("103|183|217|208|214|217|208|219|224|135|175|208|206|207|204|218|219|135|189|200|211|220|204"), false, function(val)
    _vigmhnzg._c43hvqpz = val
    if val then _vigmhnzg._chhggl0w = false end
end)

_fp1qs1bk(_lrfe53he, _xD("94|174|208|199|205|208|199|210|215|126|161|202|205|209|195|209|210"), true, function(val)
    _vigmhnzg._chhggl0w = val
    if val then _vigmhnzg._c43hvqpz = false end
end)

_fy43dfhc(_lrfe53he, _xD("61|131|158|175|170|93|143|158|161|166|178|176"), 50, 2000, 500, function(val)
    _vigmhnzg._c2iqjsp8 = val
end)

_fy43dfhc(_lrfe53he, _xD("102|172|199|216|211|134|170|203|210|199|223"), 1, 100, 5, function(val)
    _vigmhnzg._chhnsimz = val / 100
end)

_f24dad9i(_lrfe53he, _xD("44|284|203|192|185|76|127|143|141|154|76|126|155|143|151|159|76|122|155|163"), Color3.fromRGB(40, 80, 160), function()
    local rocks = _fkqbf2wo()
    _ffeb10zc(_xD("55|125|166|172|165|155|87") .. #rocks .. _xD("82|114|196|193|181|189|197|129|181|196|203|197|198|179|190|197"))
end)

_f24dad9i(_lrfe53he, _xD("120|346|275|263|152|197|225|230|221|152|198|221|217|234|221|235|236|152|202|231|219|227"), Color3.fromRGB(40, 120, 60), function()
    local rocks = _fkqbf2wo()
    if #rocks > 0 then
        _fmvl0v3o(rocks[1])
    else
        _ffeb10zc(_xD("52|130|163|84|166|163|151|159|167|84|154|163|169|162|152|85"))
    end
end)

_f24dad9i(_lrfe53he, _xD("80|306|234|241|112|147|177|179|184|181|112|162|181|189|191|196|181|195"), Color3.fromRGB(100, 50, 150), function()
    _fxwruyyt()
end)

local _l2pno6ae = _v9ijv2j3[_xD("106|189|207|214|214")]

_fm1kc2sz(_l2pno6ae, _xD("124|364|283|270|300|156|189|209|208|203|156|207|193|200|200"))

_fp1qs1bk(_l2pno6ae, _xD("65|130|182|181|176|97|148|166|173|173"), false, function(val)
    _vigmhnzg._ci3ro08l = val
    if val then _f4c6rv42() else _f76x0nx6() end
end)

_fy43dfhc(_l2pno6ae, _xD("123|206|224|231|231|155|205|220|223|228|240|238"), 50, 1000, 300, function(val)
    _vigmhnzg._chckexjd = val
end)

_fy43dfhc(_l2pno6ae, _xD("126|209|227|234|234|158|194|227|234|223|247"), 1, 50, 3, function(val)
    _vigmhnzg._c2u7t7zw = val / 10
end)

_f24dad9i(_l2pno6ae, _xD("86|326|245|232|262|118|169|187|194|194|118|183|202|118|164|187|183|200|187|201|202|118|169|190|197|198"), Color3.fromRGB(140, 100, 30), function()
    local shops = _foyeamoi()
    if #shops > 0 then
        _fwpee97o(shops[1])
    else
        _ffeb10zc(_xD("59|137|170|91|174|163|170|171|174|91|161|170|176|169|159|92"))
    end
end)

_f24dad9i(_l2pno6ae, _xD("40|280|199|183|200|72|111|151|72|112|151|149|141|72|87|72|124|141|148|141|152|151|154|156|72|156|151|72|123|144|151|152"), Color3.fromRGB(80, 50, 150), function()
    local shops = _foyeamoi()
    if #shops > 0 then
        _f6gxrnr7(shops[1].Part.Position)
        _ffeb10zc(_xD("67|151|168|175|168|179|178|181|183|168|167|99|183|178|125|99") .. shops[1].Name)
    end
end)

_fm1kc2sz(_l2pno6ae, _xD("112|352|271|260|244|144|177|197|196|191|144|197|192|183|194|177|180|181"))

_fp1qs1bk(_l2pno6ae, _xD("43|108|160|159|154|75|128|155|146|157|140|143|144"), false, function(val)
    _vigmhnzg._czs09h1q = val
    if val then _fa46z6ff() else _faacm9is() end
end)

_f24dad9i(_l2pno6ae, _xD("120|346|292|254|152|205|232|223|234|217|220|221|152|185|228|228"), Color3.fromRGB(50, 130, 180), function()
    _fzl9jbw2(_xD("101|218|213|204|215|198|201|202"))
    _fzl9jbw2(_xD("92|190|209|213"))
    _fzl9jbw2(_xD("40|152|157|154|139|144|137|155|141"))
    _fzl9jbw2(_xD("56|175|153|170|165|172|160"))
    _fzl9jbw2(_xD("41|153|146|140|148|138|161|142"))
    _fzl9jbw2(_xD("84|182|181|183|191|196|181|183|191"))
    _fzl9jbw2(_xD("113|228|225|214|214|213"))
    _ffeb10zc(_xD("70|140|175|184|171|170|102|187|182|173|184|167|170|171|102|184|171|179|181|186|171|185"))
end)

_fm1kc2sz(_l2pno6ae, _xD("79|319|238|222|249|111|147|148|163|148|146|163|148|147|111|162|151|158|159|162"))

_v1n2acbz = Instance.new("ScrollingFrame")
_v1n2acbz.Name = _xD("106|189|210|217|218|182|211|221|222")
...
local _lo1mr2i1 = _v9ijv2j3[_xD("90|159|173|170")]

_fm1kc2sz(_lo1mr2i1, _xD("82|322|241|227|211|114|151|165|162|114|129|114|168|155|165|167|147|158|165"))

_fp1qs1bk(_lo1mr2i1, _xD("55|122|169|176|170|171|152|163|87|102|87|137|166|154|162|87|124|138|135"), false, function(val)
    _vigmhnzg._cz5fhocm = val
    if val then _f2f3b73m() else _fsudja3s() end
end)

_f24dad9i(_lo1mr2i1, _xD("122|362|281|270|254|154|204|223|224|236|223|237|226|154|191|205|202"), Color3.fromRGB(50, 90, 160), function()
    if _vigmhnzg._cz5fhocm then
        _fw8os0nl()
    else
        _ffeb10zc(_xD("115|184|225|212|213|223|216|147|184|198|195|147|217|220|229|230|231|148"))
    end
end)

_f24dad9i(_lo1mr2i1, _xD("101|327|258|241|133|168|209|202|198|215|133|170|184|181"), Color3.fromRGB(150, 50, 50), function()
    _fsudja3s()
end)

_fm1kc2sz(_lo1mr2i1, _xD("66|306|225|236|234|98|134|135|150|135|133|150|135|134|98|148|145|133|141|149"))

_vpd1qod9 = Instance.new("ScrollingFrame")
_vpd1qod9.Name = _xD("123|205|234|222|230|199|228|238|239")
...
local _l1g1xp3f = _v9ijv2j3[_xD("68|137|188|180|176|179|173|184")]

_fm1kc2sz(_l1g1xp3f, _xD("102|342|261|244|248|134|171|190|182|178|181|175|186|185"))

_fp1qs1bk(_l1g1xp3f, _xD("43|128|153|151|148|152|148|159|144|143|75|109|140|142|150|155|140|142|150"), false, function(val)
    _vigmhnzg._ca54l82p = val
    if val then _fja6ipfm() end
end)

_fp1qs1bk(_l1g1xp3f, _xD("120|205|230|228|225|229|225|236|221|220|152|196|237|219|227"), false, function(val)
    _vigmhnzg._ce4vi9nh = val
    if val then _fvec0i16() end
end)

_fp1qs1bk(_l1g1xp3f, _xD("89|154|199|205|194|121|157|186|198|186|192|190"), false, function(val)
    _vigmhnzg._coe01omh = val
    if val then _fexcruef() else _fqvozuop() end
end)

_fp1qs1bk(_l1g1xp3f, _xD("53|118|163|169|158|85|123|167|154|154|175|154|85|93|140|150|167|162|169|157|94"), false, function(val)
...
_fm1kc2sz(_l1g1xp3f, _xD("63|303|222|205|236|95|140|142|149|132|140|132|141|147"))

_fp1qs1bk(_l1g1xp3f, _xD("110|193|222|211|211|210|142|176|221|221|225|226"), false, function(val)
    _vigmhnzg._cr4fnm79 = val
    _ftq12yf5()
end)

_fy43dfhc(_l1g1xp3f, _xD("60|147|157|168|167|92|143|172|161|161|160"), 16, 200, 50, function(val)
    _vigmhnzg._csiv0fed = val
    if _vigmhnzg._cr4fnm79 then _ftq12yf5() end
end)

_fp1qs1bk(_l1g1xp3f, _xD("108|186|219|207|216|213|220"), false, function(val)
    _vigmhnzg._cqgz5lhy = val
    if val then _f0jy4yoy() else _fnquejjf() end
end)

_fp1qs1bk(_l1g1xp3f, _xD("61|131|169|182"), false, function(val)
    _vigmhnzg._cd4afzmc = val
    if val then _fcx11s36() else _fwzi0fa8() end
end)

_fy43dfhc(_l1g1xp3f, _xD("119|189|227|240|151|202|231|220|220|219"), 10, 200, 60, function(val)
    _vigmhnzg._clebcwww = val
end)

_fm1kc2sz(_l1g1xp3f, _xD("126|366|285|273|292|158|199|210|195|203|158|194|211|206|195"))

local _vxyy1wwc, _veykdbrr
_vxyy1wwc, _veykdbrr = _f3vsghk5(_l1g1xp3f, _xD("88|156|205|200|189|120|169|204|209"), "1", function(text)
...
_f24dad9i(_l1g1xp3f, _xD("49|289|208|196|215|81|117|166|161|150|81|122|165|150|158|164|81|89") .. _vigmhnzg._c5fo1mye .. _xD("89|209|130"), Color3.fromRGB(180, 60, 180), function()
    _ffq5hqow(_vigmhnzg._c5fo1mye)
end)

_fm1kc2sz(_l1g1xp3f, _xD("103|343|262|250|264|135|185|172|180|182|187|172|135|172|191|183|179|182|176|187|186"))

_f24dad9i(_l1g1xp3f, _xD("101|341|260|249|266|133|171|206|215|202|133|166|209|209|133|178|206|211|202|133|183|202|210|212|217|202|216"), Color3.fromRGB(160, 40, 40), function()
    _fzl9jbw2(_xD("121|230|226|231|222"))
    _fzl9jbw2(_xD("59|159|164|162"))
    _fzl9jbw2(_xD("95|199|192|209|213|196|210|211"))
    _fzl9jbw2(_xD("42|141|153|150|150|143|141|158"))
    _fzl9jbw2(_xD("124|222|238|225|221|231"))
    _ffeb10zc(_xD("44|114|149|158|145|144|76|153|149|154|145|76|158|145|153|155|160|145|159"))
end)

_f24dad9i(_l1g1xp3f, _xD("59|299|218|205|235|91|129|164|173|160|91|124|167|167|91|142|160|167|167|91|141|160|168|170|175|160|174"), Color3.fromRGB(40, 140, 40), function()
    _fzl9jbw2(_xD("129|244|230|237|237"))
    _fzl9jbw2(_xD("81|196|182|189|189|178|189|189"))
    _fzl9jbw2(_xD("71|170|168|186|175"))
    _fzl9jbw2(_xD("105|214|216|215|206|226"))
    _fzl9jbw2(_xD("81|197|195|178|181|182"))
    _ffeb10zc(_xD("85|155|190|199|186|185|117|200|186|193|193|117|199|186|194|196|201|186|200"))
end)

_f24dad9i(_l1g1xp3f, _xD("92|318|264|226|124|162|197|206|193|124|157|200|200|124|177|204|195|206|189|192|193|124|174|193|201|203|208|193|207"), Color3.fromRGB(40, 100, 160), function()
    _fzl9jbw2(_xD("46|163|158|149|160|143|146|147"))
    _fzl9jbw2(_xD("84|182|201|205"))
    _fzl9jbw2(_xD("52|164|169|166|151|156|149|167|153"))
    _fzl9jbw2(_xD("72|191|169|186|181|188|176"))
    _fzl9jbw2(_xD("102|214|207|201|209|199|222|203"))
    _fzl9jbw2(_xD("91|189|188|190|198|203|188|190|198"))
    _ffeb10zc(_xD("108|178|213|222|209|208|140|225|220|211|222|205|208|209|140|222|209|217|219|224|209|223"))
end)

_f24dad9i(_l1g1xp3f, _xD("130|370|289|272|308|162|200|235|244|231|162|195|238|238|162|206|247|229|237|162|212|231|239|241|246|231|245"), Color3.fromRGB(140, 140, 40), function()
    _fzl9jbw2(_xD("102|210|219|201|209"))
    _fzl9jbw2(_xD("98|206|215|197|205|219"))
    _fzl9jbw2(_xD("66|168|177|180|182|183|176|167"))
    _fzl9jbw2(_xD("45|143|153|146|160|160|150|155|148"))
    _ffeb10zc(_xD("114|184|219|228|215|214|146|222|231|213|221|146|228|215|223|225|230|215|229"))
end)

_f24dad9i(_l1g1xp3f, _xD("124|364|283|270|287|156|194|229|238|225|156|189|200|200|156|206|225|233|235|240|225|239|156|164|202|241|231|225|165"), Color3.fromRGB(200, 50, 50), function()
    for _, remote in ipairs(_v4a9zyim._svnug2j5) do
        pcall(function()
            if remote.Type == "RemoteEvent" then
    ...
    _ffeb10zc(_xD("58|136|143|133|127|126|90|155|166|166|90") .. #_v4a9zyim._svnug2j5 .. _xD("109|141|223|210|218|220|225|210|224|142"))
end)

local _ldi1sgny = _v9ijv2j3[_xD("76|153|181|191|175")]

_fm1kc2sz(_ldi1sgny, _xD("129|369|288|276|268|161|205|208|200"))

_v067lq9m = Instance.new("ScrollingFrame")
_v067lq9m.Name = _xD("120|196|231|223|196|225|235|236")
...
_fm1kc2sz(_ldi1sgny, _xD("111|351|270|259|262|143|179|184|194|178|190|193|179|143|198|180|177|183|190|190|186"))

_fp1qs1bk(_ldi1sgny, _xD("122|191|232|219|220|230|223|154|209|223|220|226|233|233|229"), false, function(val)
    _vigmhnzg._cr3pam97 = val
end)

_f3vsghk5(_ldi1sgny, _xD("75|162|176|173|179|186|186|182|107|160|157|151"), "", function(text)
    _vigmhnzg._cy11p9hq = text
end)

_fp1qs1bk(_ldi1sgny, _xD("92|162|189|206|201|124|168|203|195|207"), true, function(val)
    _vigmhnzg._cj0i834c = val
end)

_fp1qs1bk(_ldi1sgny, _xD("66|149|167|174|174|98|142|177|169|181"), true, function(val)
    _vigmhnzg._c5g5l6rn = val
end)

_fp1qs1bk(_ldi1sgny, _xD("110|193|226|207|226|225|142|186|221|213|225"), true, function(val)
    _vigmhnzg._cqprlben = val
end)

_f24dad9i(_ldi1sgny, _xD("109|349|268|256|277|141|192|210|219|209|141|192|225|206|225|224|141|187|220|228"), Color3.fromRGB(50, 90, 160), function()
    _fy4xfdo6()
    _ffeb10zc(_xD("41|124|142|151|157|73|156|157|138|157|156|73|157|152|73|160|142|139|145|152|152|148"))
end)

_f24dad9i(_ldi1sgny, _xD("92|332|251|259|262|124|176|193|207|208|124|179|193|190|196|203|203|199"), Color3.fromRGB(90, 60, 140), function()
    _f5maw08x({content = _xD("47|89|89|138|124|152|157|148|144|79|124|158|164|157|163|144|152|157|79|165|101|140|89|89|79|134|148|145|151|158|158|154|79|163|148|162|163|79|162|164|146|146|148|162|162|149|164|155|80|79|273|203|180")})
    _ffeb10zc(_xD("73|157|174|188|189|174|173|105|192|174|171|177|184|184|180"))
end)

_fm1kc2sz(_ldi1sgny, _xD("47|287|206|195|214|79|132|131|120|123|120|131|120|116|130"))

_f24dad9i(_ldi1sgny, _xD("130|370|289|273|290|162|214|231|238|231|242|241|244|246|162|246|241|162|213|242|227|249|240"), Color3.fromRGB(60, 90, 140), function()
    local spawns = Workspace:FindFirstChild(_xD("108|191|220|205|227|218|184|219|207|205|224|213|219|218")) or Workspace:FindFirstChild(_xD("76|159|188|173|195|186|191")) or Workspace:FindFirstChild(_xD("91|167|202|189|189|212"))
    if spawns then
        ...
        _ffeb10zc(_xD("110|188|221|142|225|222|207|229|220|142|212|221|227|220|210|143"))
    end
end)

_f24dad9i(_ldi1sgny, _xD("57|297|216|200|205|89|141|158|165|158|169|168|171|173|89|173|168|89|134|168|174|167|173|154|162|167|89|141|168|169"), Color3.fromRGB(100, 60, 140), function()
    if _fawdpprj() then
        ...
        if highestPart then
            ...
            _ffeb10zc(_xD("129|213|230|237|230|241|240|243|245|230|229|161|245|240|161|233|234|232|233|230|244|245|161|241|240|234|239|245|187|161") .. math.floor(_l6jmnxut))
        end
    end
end)

_f24dad9i(_ldi1sgny, _xD("128|368|287|276|260|160|210|229|234|239|233|238|160|211|229|242|246|229|242"), Color3.fromRGB(100, 100, 50), function()
    pcall(function()
        LocalPlayer:Kick(_xD("102|184|203|208|213|207|212|207|212|205|148|148|148"))
        task.wait(1)
        game:GetService(_xD("93|177|194|201|194|205|204|207|209|176|194|207|211|198|192|194")):TeleportToPlaceInstance(game.PlaceId, game.JobId, LocalPlayer)
    end)
end)

_fm1kc2sz(_ldi1sgny, _xD("111|337|243|296|143|184|189|181|190"))
...
infoLabel.Text = _xD("113|190|218|223|214|210|145|190|224|230|223|229|210|218|223|145|231|167|145|198|221|229|218|222|210|229|214|205|223|178|230|229|224|145|183|210|227|222|145|237|145|182|196|193|145|237|145|182|233|225|221|224|218|229|228|145|237|145|181|230|225|214|205|223|200|224|227|220|228|145|224|223|145|181|214|221|229|210|157|145|196|234|223|210|225|228|214|157|145|188|195|191|189|157|145|183|221|230|233|230|228")
        ...
        pcall(function()
            ...
            if _v1n2acbz then
                ...
                for i, shop in ipairs(shops) do
                    ...
                    btn.BorderSizePixel = 0
                    btn.Text = shop.Name .. " [" .. math.floor(shop.Distance) .. _xD("122|231|215")
                    ...
                    btn.MouseButton1Click:Connect(function()
                        ...
                        _ffeb10zc(_xD("85|169|186|193|186|197|196|199|201|186|185|117|201|196|143|117") .. shop.Name)
                    end)
                end
            end
        end)
        ...
        pcall(function()
            ...
            if _vpd1qod9 then
                ...
                for i, rock in ipairs(rocks) do
                    ...
                    btn.BackgroundColor3 = Color3.fromRGB(30, 35, 50)
                    btn.BorderSizePixel = 0
                    btn.Text = rock.Name .. " [" .. math.floor(rock.Distance) .. _xD("46|155|139") .. (rock.Value > 0 and (" $" .. rock.Value) or "")
                    ...
                    btn.MouseButton1Click:Connect(function()
                        ...
                        _ffeb10zc(_xD("48|132|149|156|149|160|159|162|164|149|148|80|164|159|106|80") .. rock.Name)
                    end)
                end
            end
        end)
...
LocalPlayer.CharacterAdded:Connect(function(char)
    Character = char
    HumanoidRootPart = char:WaitForChild(_xD("107|179|224|216|204|217|218|212|207|189|218|218|223|187|204|221|223"))
    Humanoid = char:WaitForChild(_xD("108|180|225|217|205|218|219|213|208"))
    _ffeb10zc(_xD("55|122|159|152|169|152|154|171|156|169|87|169|156|170|167|152|174|165|156|155"))
...
Workspace.CurrentCamera:GetPropertyChangedSignal(_xD("47|133|152|148|166|159|158|161|163|130|152|169|148")):Connect(function()
    local newSize = Workspace.CurrentCamera.ViewportSize
    local isMob = newSize.X < 800
    _vs51ifck = isMob and UDim2.new(0.95, 0, 0, 480) or UDim2.new(0, 380, 0, 540)
...
_ffeb10zc(_xD("113|190|218|223|214|210|145|190|224|230|223|229|210|218|223|145|231|167|145|198|189|197|186|190|178|197|182|145|189|224|210|213|214|213|146"))
_ffeb10zc(_xD("47|112|164|163|158|79|117|144|161|156|79|171|79|116|130|127|79|171|79|116|167|159|155|158|152|163|162|79|171|79|115|164|159|148"))
_ffeb10zc(_xD("79|146|176|178|183|180|111|193|180|188|190|195|180|194|111|181|184|193|194|195|111|181|190|193|111|177|180|194|195|111|193|180|194|196|187|195|194|112"))
